...
1. Use Git on the CLI
  ...
  1. Commit your changes with the message `commit #3 from CLI`. Add a link to this commit to [completions](#completions).
...
1. In Atom, edit this README file and add your *third* favorite emoji to [completions](#completions).
...
1. Commit your changes directly to the main branch with the message `commit #4 from Atom`. Add a link to this commit to [completions](#completions).
